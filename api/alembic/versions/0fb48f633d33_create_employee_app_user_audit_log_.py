"""create employee, app_user, audit_log tables

Revision ID: 0fb48f633d33
Revises:
Create Date: 2026-09-15 16:06:04.619020
...
def upgrade() -> None:
    """Upgrade schema."""
    # pg_trgm powers the fuzzy-name GIN index created below.
    ...
    # --- Hand-added: constraints and indexes autogenerate cannot produce ---
    # (functional/partial indexes and CHECK constraints aren't reflected)
